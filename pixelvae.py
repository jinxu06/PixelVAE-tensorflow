...
def pixel_vae(x, px, f=None, z_ph=None, z_dim=32, img_size=64, nr_final_feature_maps=32, dropout_p=0.5, nr_resnet=5, nr_filters=160, nr_logistic_mix=10):
    ...
    x_out = shallow_pixel_cnn(px, gh=z_ph, sh=f, dropout_p=dropout_p, nr_resnet=nr_resnet,
