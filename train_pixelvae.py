...
for i in range(args.nr_gpu):
    with tf.device('/gpu:%d' % i):
        ...
        klds[i] = compute_mmd(tf.random_normal(shape=(args.batch_size, args.z_dim)), z_samples[i])
        ...
        test_klds[i] = compute_mmd(tf.random_normal(shape=(args.batch_size, args.z_dim)), test_z_samples[i])
