...
# model
parser.add_argument('-q', '--nr_resnet', type=int, default=6, help='Number of residual blocks per stage of the model')
...
model = tf.make_template('model', shallow_pixel_cnn)
