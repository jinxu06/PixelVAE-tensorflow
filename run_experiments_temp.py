...
with tf.Session(config=config) as sess:
    ...
    visualize_samples(gt_data, "/data/ziz/jxu/gpu-results/recon_gt_center_mmd_2e6_randomz.png", layout=(4,4))
    visualize_samples(sample_x, "/data/ziz/jxu/gpu-results/recon_sample_center_mmd_2e6_randomz.png", layout=(4,4))
